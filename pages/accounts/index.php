			...
			<div class="accordion" id="accordionExample">
				...
				<div class="collapse" id="collapseExample1">
					<div style="padding-top: 20px;padding-bottom: 20px;" class="container-fluid">
						<button class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-plus"></i> Add Admin Account</button>
					</div>
					<!-- Add Admin Modal -->
									...
									while ($row = $result -> fetch_assoc()) 
									{
										...
										<tr id="<?php echo $row["id"];?>">
											...
											<td><button  data-toggle="modal" data-target="#exampleModalCenter1"  class="btn btn-info edit-admin"><i style="font-size: 15px;" class='fas fa-pen'></i></button>
												<button type="button" class="btn btn-danger delete-admin"><i style="font-size: 15px;" class='far fa-trash-alt'></i></button>
											</td>
										</tr>
										<?php
									}
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								...
								<div class="modal-body add-admin-div">
									...
									<label for="cashier-pass">Password*</label>
									<input type="Password" id="cashier-pass" class="form-control" placeholder="Password">

									<label for="cashier-con-pass">Confirm Password*</label>
									<input type="Password" id="cashier-con-pass" class="form-control" placeholder="Confirm Password">
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
									<button id="add-cashier-btn" type="button" class="btn btn-success">Add</button>
								</div>
							</div>
						</div>
					</div>
								...
								if ($result2 -> num_rows > 0) 
								{
									while ($row = $result2 -> fetch_assoc()) 
									{
										...
										<tr id="<?php echo $row["id"];?>">
											...
											<td><span><?php echo $row["username"]; ?></span></td>
											<td><span class="password-td"><?php echo $row["password"]; ?></span><button class="see-password"><i class='far fa-eye'></i></button></td>
											<td><button  data-toggle="modal" data-target="#exampleModalCenter2"  class="btn btn-info edit-cashier"><i style="font-size: 15px;" class='fas fa-pen'></i></button>
